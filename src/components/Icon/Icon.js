...
const TwitterIcon = ({ width = "14px", height = "14px", className }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      className={className}
...
const FacebookIcon = ({ width = "16px", height = "16px", className }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      className={className}
...
const InstagramIcon = ({ width = "18px", height = "18px", className }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      className={className}
...
export { CalendarIcon, TwitterIcon, FacebookIcon, InstagramIcon };
